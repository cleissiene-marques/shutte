...
export const metadata: Metadata = {
  title: "IPTV Teste Grátis por Estado: Ranking Completo",
  description: "Teste grátis de IPTV sem cartão de crédito, com ranking separado por estado: estabilidade, suporte e preço para assinantes de todas as regiões do Brasil.",
    ...
    <>
      <section className="hero page-hero" aria-labelledby="hero-heading">
        <div className="container">
          <div className="label">IPTV por estado</div>
          <h1 className="hero-title" id="hero-heading">
            IPTV com <span className="hl-1">teste grátis</span> em cada estado do Brasil
          </h1>
          <p className="hero-desc">
            O ranking da Shutte é nacional e todos os provedores oferecem teste grátis, sem cartão de crédito. Escolha seu estado para ver o ranking com contexto local, preços e perguntas frequentes específicas.
          </p>
        </div>
      </section>
