    ...
    <>
      ...
      <section className="section" aria-labelledby="story-heading">
        <div className="container">
          ...
          <h2 className="section-heading" id="story-heading" style={{ marginTop: "16px" }}>Um ranking pensado para facilitar a escolha</h2>
          <div className="legal-content" style={{ marginTop: "32px" }}>
            ...
            <p>Preferimos um ranking pequeno e bem avaliado a uma lista enorme sem critério. Por isso, cada provedor listado passa pelos cinco critérios abaixo antes de receber uma posição.</p>
          </div>
        </div>
      </section>
      ...
      <section className="final-cta" aria-labelledby="cta-heading">
        <div className="container">
          ...
          <h2 className="section-heading" id="cta-heading" style={{ marginTop: "16px" }}>Veja o ranking completo</h2>
